...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ChikoritasTeam", "DinoNavesita", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "DinoNavesita";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "DinoNavesita", null, { width: 512, height: 480 });
